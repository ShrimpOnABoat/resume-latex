...
\ifthenelse{\boolean{EN}}{%
  ...
  \resumeSection{Objectif professionnel}{
        Développeur Python expérimenté avec plus de 20 ans d’expérience en développement logiciel, analyse de données et gestion de projets. Je cherche à intégrer une équipe agile et innovante, où je pourrai contribuer à la conception et au développement d’applications performantes, notamment via Python, FastAPI, Flask ou Django, dans des environnements cloud et CI/CD.
  }
}
