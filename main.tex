...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Professional objective}{
    Experienced Python Developer with over 20 years of experience in software development, data analysis, and project management. I’m seeking to join an agile and innovative team where I can contribute to designing and developing high-performance applications using Python, FastAPI, Flask, or Django in cloud-based and CI/CD environments.
  }
}{%
  \resumeSection{Objectif professionnel}{
    Développeur Python expérimenté avec plus de 20 ans d’expérience en développement logiciel, analyse de données et gestion de projets. Je souhaite intégrer une équipe agile et innovante où je pourrai contribuer à la conception et au développement d’applications performantes avec Python, FastAPI, Flask ou Django, dans des environnements cloud et CI/CD.
  }
}
...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Technical Skills \& Tools}{
    \skillItem{Programming \& Scripting}{Python, JavaScript (React, Node.js), C, Swift, SQL, Bash, C++, asynchronous programming}
    \skillItem{Web \& Software Development}{Flask, FastAPI, Django, Firebase, WebRTC}
    \skillItem{Cloud \& DevOps}{AWS, Google Cloud Platform, Azure, Git, CI/CD (Azure DevOps)}
  ...
  \resumeSection{Compétences techniques \& Outils}{
    \skillItem{Programmation \& scripts}{Python, JavaScript (React, Node.js), C, Swift, SQL, Bash, C++, programmation asynchrone}
