...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Professional objective}{
    Bilingual software developer seeking to grow into a Software Architect role within a hybrid team in Montreal. I aim to leverage my experience in Python, cloud platforms, and CI/CD to design secure, scalable solutions while deepening my knowledge in DevOps, architecture, and cross-functional collaboration.
  }
}{%
  \resumeSection{Objectif professionnel}{
    Développeur bilingue en quête d’un rôle évolutif vers l’architecture logicielle au sein d’une équipe hybride à Montréal. Je souhaite mettre à profit mon expérience en Python, plateformes cloud et CI/CD pour concevoir des solutions sécurisées et évolutives, tout en approfondissant mes connaissances en DevOps, architecture et collaboration interdisciplinaire.
  }
}
