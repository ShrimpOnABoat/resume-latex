...
\newcommand{\CompanyName}{Exertis JAM}
...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Professional objective}{
    Seeking a software developer role at Exertis JAM where I can leverage my end‑to‑end SDLC expertise, multi‑language skills, and passion for elegant, maintainable code to deliver reliable internal tools and customer‑facing applications.
  }
}{%
  \resumeSection{Objectif professionnel}{
    À la recherche d’un poste de développeur logiciel chez Exertis JAM afin de mettre à profit mon expertise du cycle SDLC complet, mes compétences multilingues en programmation et mon goût du code élégant et maintenable pour livrer des applications fiables et centrées utilisateur.
  }
}
