...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Profile Highlights}{
    \begin{itemize}[topsep=0pt, partopsep=0pt, parsep=0pt, leftmargin=1em, itemsep=-0.1em]
      \item 8+ years delivering end‑to‑end software solutions across the full SDLC—from requirements and architecture to testing, deployment and support—in fast‑moving teams.
      \item Strong multi‑language developer (Python, JavaScript/TypeScript, C, C++) able to quickly learn and apply new technologies.
      \item Hands‑on experience maintaining and refactoring legacy codebases: profiling performance, debugging production issues and writing unit tests to prevent regressions.
      \item Adept at collaborating with business stakeholders, documenting technical solutions and leading peer code reviews within Agile environments.
    \end{itemize}
  }
}{%
  \resumeSection{Faits saillants du profil}{
    \begin{itemize}[topsep=0pt, partopsep=0pt, parsep=0pt, leftmargin=1em, itemsep=-0.1em]
      \item Plus de 8 ans de développement de solutions logicielles de bout en bout, couvrant tout le cycle SDLC—de la collecte des besoins à la maintenance—au sein d’équipes réactives.
      \item Développeur polyvalent (Python, JavaScript/TypeScript, C, C++) capable d’apprendre rapidement de nouvelles technologies et méthodologies.
      \item Expérience pratique dans la maintenance et la refonte de bases de code existantes : profilage des performances, débogage en production et écriture de tests unitaires pour éviter les régressions.
      \item Habile à collaborer avec les parties prenantes, documenter les solutions techniques et animer les revues de code dans des environnements Agile.
    \end{itemize}
  }
}
...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Professional objective}{
    Seeking a senior backend role at Flexter where I can help scale infrastructure and backend systems using modern Python APIs, cloud platforms, and DevOps practices. I aim to contribute to a fast-moving, innovative team focused on delivering reliable, high-performance software.  }
}{%
  \resumeSection{Objectif professionnel}{
        À la recherche d’un poste de développeur backend senior chez Flexter afin de participer à la montée en charge de plateformes cloud modernes et microservices, en mettant à profit mon expertise Python, mes pratiques DevOps et mon goût pour l’innovation dans un contexte startup.
  }
}
...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Technical Skills \& Tools}{
    ...
    \skillItem{Databases}{PostgreSQL, MySQL, MongoDB, Oracle, MS SQL Server, cron}
  ...
  \resumeSection{Compétences techniques \& Outils}{
    ...
    \skillItem{Cloud \& DevOps}{AWS, Google Cloud Platform, Azure, Docker, Git, CI/CD (Azure DevOps)}
    \skillItem{Bases de données}{PostgreSQL, MySQL, MongoDB, Oracle, MS SQL Server, cron}
