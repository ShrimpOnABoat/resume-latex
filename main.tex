...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Professional objective}{
    Seeking a data-oriented Python role in financial services where I can leverage my experience with RDBMS, MongoDB, scripting, and Linux-based automation to improve system reliability and performance.
  }
}{%
  \resumeSection{Objectif professionnel}{
    À la recherche d’un poste orienté données en Python dans le secteur financier, où je pourrais mettre à profit mon expérience avec les bases de données relationnelles, MongoDB, les scripts d’automatisation et l’environnement Linux pour renforcer la fiabilité et la performance des systèmes.
  }
}
...
\ifthenelse{\boolean{EN}}{%
  \resumeSection{Technical Skills \& Tools}{
    \skillItem{Programming \& Scripting}{Python, asynchronous programming, JavaScript (React, Node.js), TypeScript, C, Swift, SQL, Bash, C++}
  ...
  \resumeSection{Compétences techniques \& Outils}{
    \skillItem{Programmation \& scripts}{Python, programmation asynchrone, JavaScript (React, Node.js), TypeScript, C, Swift, SQL, Bash, C++}
